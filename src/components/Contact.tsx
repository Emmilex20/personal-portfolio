            ...
            <div className="flex justify-center items-center">
                <ul className="space-y-4">
                    <li className="flex items-center">
                        ...
                        <p className="text-base md:text-xl break-words">+234 913 206 2212</p>
                    </li>
                    <li className="flex items-center">
                        <Image src={mail} alt="mail" className="h-[110px] w-auto mr-4 md:mr-6" />
                        <p className="text-base md:text-xl break-words">aginaemmanuel6@gmail.com</p>
                    </li>
                </ul>
            </div>
